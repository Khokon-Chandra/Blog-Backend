            ...
            <div class="slider-area">
                <div class="bend niceties preview-2">
                    <div id="ensign-nivoslider" class="slides">
                        <img src="{{ asset('frontend/images/slider/slide_1.jpg') }}" alt="" title="#slider-direction-1" />
                        <img src="{{ asset('frontend/images/slider/slide_3.jpg') }}" alt="" title="#slider-direction-2" />
                    </div>
                    <!-- direction 2 -->
            ...
            <div class="slider-right">
                <ul>
                    <li>
                        ...
                        <div class="right-image"><a href="blog-single.html"><img src="{{ asset('frontend/images/sidebar-images/1.jpg') }}" alt="sidebar image"></a></div>
                    </li>
                    <li>
                        <div class="right-content">
                        ...
                        <div class="right-image"><a href="blog-single.html"><img src="{{ asset('frontend/images/sidebar-images/2.jpg') }}" alt="sidebar image"></a></div>
                    </li>
                    <li>
                        <div class="right-content">
